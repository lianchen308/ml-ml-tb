% [y_test_auc, y_test_acc, y_train_auc, y_train_acc] = mabeval(learners, weights, X_train, y_train, X_test, y_test) 
function [y_test_auc, y_test_acc, y_train_auc, y_train_acc] = mabeval(learners, weights, X_train, y_train, X_test, y_test) 
